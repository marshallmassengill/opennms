...
public class AuthConfigurationTest extends XmlTestNoCastor<AuthConfiguration> {

    public AuthConfigurationTest(final AuthConfiguration sampleObject,
    ...
    public static Collection<Object[]> data() {
        // Empty configuration.
        final AuthConfiguration empty = new AuthConfiguration();
        ...
        final AuthConfiguration populated = new AuthConfiguration();
        ...
        return Arrays.asList(new Object[][]{
                {
                        ...
                        "target/classes/xsds/auth-configuration.xsd"
                },
                {
                        populated,
                        "<auth-configuration xmlns=\"http://xmlns.opennms.org/xsd/config/auth\">"
